...
<!-- Hero Section -->
  <section class="hero" id="hero">
   <a class="hero_header" href="#"><img id="hero_header" src="http://drive.google.com/uc?export=view&id=1puFmUToMb3Kau5gQUKc5HukHSzoYy6sn" style=" margin-top: -100px; width: 860px; height: 700px;"></a>
    <p class="tagline"> أهلاً بك في <br> المصحح العربي<br><br><strong> .. ريشة</strong> </p>
   </section>

  <!-- About Section -->

  <article class="text_column" style="margin-top: -28px;">
    <h3 style="text-align: center;">  تحب الكتابة والإملاء؟ ممتاز! </h3>
        <p style="text-align: center;"> :شاركنا بصورة لكلمة بخط يدك لتقوم ريشة بتصحيحها </p>
      <form method="post" enctype="multipart/form-data" style="text-align: center">
        ...
        <br>
        <input class="button" type="submit" value="تصحيح" style="margin-top: 25px;" > 
           </form>
      </article> 
     <!-- About Section -->
